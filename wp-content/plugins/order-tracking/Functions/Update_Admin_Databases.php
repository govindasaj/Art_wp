...
function Update_EWD_OTP_Options() {
	...
	if (isset($_POST['allow_sales_rep_selection']) and $EWD_OTP_Full_Version == "Yes") {update_option('EWD_OTP_Allow_Sales_Rep_Selection', $_POST['allow_sales_rep_selection']);}
	if (isset($_POST['auto_assign_orders_to_customers']) and $EWD_OTP_Full_Version == "Yes") {update_option('EWD_OTP_Auto_Assign_Orders_To_Customers', $_POST['auto_assign_orders_to_customers']);}
	if (isset($_POST['customer_order_number_prefix']) and $EWD_OTP_Full_Version == "Yes") {update_option('EWD_OTP_Customer_Order_Number_Prefix', $_POST['customer_order_number_prefix']);}
	if (isset($_POST['customer_order_number_suffix']) and $EWD_OTP_Full_Version == "Yes") {update_option('EWD_OTP_Customer_Order_Number_Suffix', $_POST['customer_order_number_suffix']);}
	if (isset($_POST['default_sales_rep']) and $EWD_OTP_Full_Version == "Yes") {update_option('EWD_OTP_Default_Sales_Rep', $_POST['default_sales_rep']);}
	...
	if ($EWD_OTP_Full_Version == "Yes" and isset($_POST['retrieving_results_label'])) {update_option("EWD_OTP_Retrieving_Results_Label", $_POST['retrieving_results_label']);}
	...
	if ($EWD_OTP_Full_Version == "Yes" and isset($_POST['order_update_status_button_label'])) {update_option("EWD_OTP_Order_Update_Status_Button_Label", $_POST['order_update_status_button_label']);}
